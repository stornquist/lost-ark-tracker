        ...
        function (module, __webpack_exports__, __webpack_require__) {
                ...
                return promise(function (res, rej) {
                  ...
                  dbOpenRequest.onupgradeneeded = function (e) {
                    ...
                    var createObjectStore = function (table) {
                      ...
                      if (
                        upgradeConnection.objectStoreNames.contains(table.name)
                      ) {
                        upgradeConnection.deleteObjectStore(table.name);
                      }

                      var store = upgradeConnection.createObjectStore(
                        table.name,
                        option
                      );
              ...
              LogHelper.prototype.getMsg_ = function () {
                ...
                switch (this.type) {
                  ...
                  case ERROR_TYPE.TableNotExist:
                    errMsg =
                      "Table '" + this.info_['tableName'] + "' does not exist";
                    break;
            ...
            (function () {
                ...
                var addToSingleQry = function (qry, keys) {
                  ...
                  keys.forEach(function (prop) {
                    ...
                    if (value[QUERY_OPTION.NotEqualTo] != null) {
                      qry[prop][QUERY_OPTION.GreaterThan] =
              ...
              QueryHelper.prototype.checkInsertQuery = function (query) {
                ...
                if (query.skipDataCheck) {
                  ...
                  var valueCheckerInstance = new values_checker_ValuesChecker(
                    table,
                    table.autoIncColumnValue
                  );

                  var _a = valueCheckerInstance.checkAndModifyValues(
                      query.values
                    ),
                    values = _a.values,
                    err_1 = _a.err;
          ...
          var insert_Insert =
            ...
            (function (_super) {
              ...
              Insert.prototype.execute = function (db) {
                ...
                var err = new query_helper_QueryHelper(db).validate(
                  API.Insert,
                  this.query
                );
            ...
            if (
              ...
              if (this.objectStore.indexNames.contains(this.query.order.by)) {
                var orderType =
                  ...
                  this.query.order.type.toLowerCase() === 'desc'
                    ? 'prev'
                    : 'next';
                this.sorted = true;
                ...
                return promiseReject(
                  new log_helper_LogHelper(ERROR_TYPE.ColumnNotExist, {
                ...
                if (order.case == null) {
                  ...
                  this.results.sort(function (a, b) {
                    return orderMethod_1(
                      _this.thenEvaluator.setValue(a).evaluate(),
                      _this.thenEvaluator.setValue(b).evaluate()
                    );
                  });
                }
              }
            ...
            for (var prop in this.query.aggregate) {
              ...
              switch (aggregateValType) {
                case DATA_TYPE.String:
                  ...
                  results[prop + '(' + columnToAggregate + ')'] =
                    aggregateCalculator();
                  break;
          ...
          var processGroupBy = function () {
            ...
            if (getDataType(groupBy) !== DATA_TYPE.Object) {
              ...
              if (caseQueryLength === 1) {
                ...
                for (var i in datas) {
                  lookUpObj[this.thenEvaluator.setValue(datas[i]).evaluate()] =
                    datas[i];
                }
              } else {
                var objKey = void 0;
            ...
            var calculateAggregate = function () {
              ...
              for (var prop in aggregateQry) {
                ...
                switch (aggregateValType) {
                  case DATA_TYPE.String:
                    columnToAggregate = aggregateColumn;
                    datas[index][prop + '(' + columnToAggregate + ')'] =
                      aggregateCalculator();
                    break;
              ...
              if (getDataType(aggregateQry.avg) === DATA_TYPE.String) {
                for (index in datas) {
                  var sumForAvg = datas[index]['sum(' + aggregateQry.avg + ')'],
                    countForAvg =
                      datas[index]['count(' + aggregateQry.avg + ')'];
                  datas[index]['avg(' + aggregateQry.avg + ')'] =
                ...
                var isSumTypeString =
                  getDataType(aggregateQry.sum) === DATA_TYPE.String;
          ...
          var getRegexFromLikeExpression = function (likeExpression) {
            ...
            if (filterValues[1]) {
              ...
              occurence =
                filterValues.length > 2 ? OCCURENCE.Any : OCCURENCE.Last;
            } else {
          ...
          var clone_isObject = function (value) {
            return (
              getDataType(value) === 'object' && !(value instanceof RegExp)
            );
          };
                  ...
                  if (getDataType(whereColumnValue) === 'object') {
                    for (var key in whereColumnValue) {
                      ...
                      switch (key) {
                        ...
                        case QUERY_OPTION.LessThanEqualTo:
                        case QUERY_OPTION.NotEqualTo:
                          status = this.checkComparisionOp_(
                            columnName,
                            columnValue,
                            key
                          );
              ...
              BaseFetch.prototype.goToWhereLogic = function () {
                ...
                if (this.objectStore.indexNames.contains(firstColumn)) {
                  ...
                  if (getDataType(value) === 'object') {
                    var checkFlag =
                      getLength(value) > 1 || getLength(query.where) > 1;
                    this.whereCheckerInstance = new where_checker_WhereChecker(
                      query.where,
                      checkFlag
                    );
                    ...
                    switch (key) {
                      case QUERY_OPTION.Like: {
                        var regexVal = getRegexFromLikeExpression(
            ...
            (function () {
              ...
              Join.prototype.execute = function () {
                ...
                return this.executeSelect({
                  ...
                  _this.results = results.map(function (item) {
                    ...
                    return (
                      (_a = {}), (_a[_this.currentQueryStackIndex_] = item), _a
                    );
                  });
                  ...
                  try {
                    ...
                    this.results.forEach(function (result) {
                      ...
                      for (var i = 1; i < tablesLength_1; i++) {
                        ...
                        data = __assign(
                          __assign({}, data),
                          mapWithAlias_1(query_1, result[i])
                        );
                      }
              ...
              Join.prototype.checkJoinQuery_ = function (jointblInfo, qry) {
                ...
                tableSchemaOf1stTable.columns.every(function (column) {
                  var columnFound = tableSchemaOf2ndTable.columns.find(
                    function (q) {
                ...
                if (cursor) {
                  try {
                    var cursorUpdateRequest = cursor.update(
                      updateValue(setValue, cursor.value)
                    );
              ...
              Update.prototype.executeComplexLogic_ = function () {
                ...
                return selectObject.execute(this.db).then(function (results) {
                  ...
                  var whereQry =
                    ((_a = {}),
                    (_a[key] =
                      ((_b = {}), (_b[QUERY_OPTION.In] = inQuery), _b)),
                    _a);
              ...
              Remove.prototype.processWhereArrayQry = function () {
                ...
                return selectObject.execute(this.db).then(function (results) {
                  ...
                  var whereQry =
                    ((_a = {}),
                    (_a[pkey] =
                      ((_b = {}), (_b[QUERY_OPTION.In] = keyList), _b)),
                    _a);
                  ...
                  return promise(function (res, rej) {
                    clearRequest.onsuccess = function () {
                      ...
                      meta_helper_MetaHelper
                        .set(meta_helper_MetaHelper.dbSchema, db, _this.util)
                        .then(function () {
                          res();
                        })
                        .catch(rej);
          ...
          var query_manager_QueryManager =
            ...
            (function () {
              ...
              QueryManager.prototype.run = function (request) {
                ...
                switch (request.name) {
                  ...
                  case API.Transaction:
                    queryResult = new transaction_Transaction(
                      request.query,
                      this.util
                    ).execute(this.db);
                    break;
                  ...
                  case API.Get:
                    queryResult = meta_helper_MetaHelper.get(
                      request.query,
                      this.util
                    );
                    break;
                  ...
                  case API.Set:
                    var query = request.query;
                    queryResult = meta_helper_MetaHelper.set(
                      query.key,
                      query.value,
                      this.util
                    );
                  ...
                  default:
                    console.error(
                      'The Api:-' + request.name + ' does not support.'
                    );
              ...
              QueryManager.prototype.initDb = function (dataBase) {
                ...
                if (!IS_IDB_SUPPORTED) {
                  return promiseReject(
                    new log_helper_LogHelper(ERROR_TYPE.IndexedDbNotSupported)
                  );
                }
                ...
                var upgradeDbSchema = function (result) {
                  return promise(function (res, rej) {
                    meta_helper_MetaHelper
                      .get(meta_helper_MetaHelper.dbSchema, _this.util)
